...
<header>
    <div class="menu">
        <a href="index.php" class="link">
            ...
            <span class="link-title">Inici</span>
        </a>

        <a href="acerca.php" class="link">
            <span class="link-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="192" height="192" fill="currentColor" viewBox="0 0 256 256">
                    <rect width="256" height="256" fill="none"></rect>
        ...
        <a href="read.php" class="link">
            <span class="link-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="192" height="192" fill="currentColor" viewBox="0 0 256 256">
                    <rect width="256" height="256" fill="none"></rect>
                    <path d="M216,48H40a8,8,0,0,0-8,8V192a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V56A8,8,0,0,0,216,48Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path>
                    <polyline points="224 56 136 136 48 56" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline>
                </svg>
            </span>
            <span class="link-title">Missatges</span>
        </a>
        ...
        <a href="contacto.php" class="link">
            ...
            <span class="link-title">Contacte</span>
        </a>
    </div>
</header>
